...
type Spanner interface {
	...
	CommitSpan(ctx context.Context, minimalSpan span.Span, validators, producers []stakeTypes.MinimalVal, state vm.StateDB, header *types.Header, chainContext core.ChainContext, tracer *tracing.Hooks) error
}

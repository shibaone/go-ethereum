...
var (
	...
	BattlefieldFlag = &cli.BoolFlag{
		Name:     "battlefield",
		Usage:    "StreamingFast Firehose Battlefield test network: pre-configured Clique test network",
		Category: flags.EthCategory,
	}
...
func SetEthConfig(ctx *cli.Context, stack *node.Node, cfg *ethconfig.Config) {
	...
	fmt.Fprintf(os.Stderr, "[Firehose] Battlefield flag set? %t\n", ctx.Bool(BattlefieldFlag.Name))
	...
	case ctx.Bool(BattlefieldFlag.Name):
		fmt.Fprintf(os.Stderr, "[Firehose] Battlefield flag configured\n")
	...
	fmt.Fprintf(os.Stderr, "[Firehose] Genesis is nil in makeConfig? %t\n", cfg.Genesis == nil)
...
func RegisterFilterAPI(stack *node.Node, backend ethapi.Backend, ethcfg *ethconfig.Config) *filters.FilterSystem {
	...
	fmt.Fprintf(os.Stderr, "[Firehose] Genesis is nil in RegisterFilterAPI? %t\n", ethcfg.Genesis == nil)
...
func MakeGenesis(ctx *cli.Context) *core.Genesis {
	...
	case ctx.Bool(BattlefieldFlag.Name):
		genesis = core.DefaultBattlefieldGenesisBlock()
	case ctx.Bool(DeveloperFlag.Name):

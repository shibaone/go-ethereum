...
func (*firehoseTxData) gasPriceU256() *uint256.Int { panic(txDataUpdatedMessage) }
...
func (*firehoseTxData) gasTipCapU256() *uint256.Int { panic(txDataUpdatedMessage) }
func (*firehoseTxData) gasFeeCap() *big.Int         { panic(txDataUpdatedMessage) }
func (*firehoseTxData) gasFeeCapU256() *uint256.Int { panic(txDataUpdatedMessage) }

func (*firehoseTxData) blobGas() uint64 { panic(txDataUpdatedMessage) }
func (*firehoseTxData) blobGasFeeCap() *big.Int {
	panic(txDataUpdatedMessage)
}
func (*firehoseTxData) blobGasFeeCapU256() *uint256.Int {
	panic(txDataUpdatedMessage)
}
func (*firehoseTxData) blobHashes() []common.Hash { panic(txDataUpdatedMessage) }

func (f *firehoseTxData) decode([]byte) error        { panic(txDataUpdatedMessage) }
func (f *firehoseTxData) encode(*bytes.Buffer) error { panic(txDataUpdatedMessage) }

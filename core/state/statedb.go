...
type StateDB struct {
	...
	// Firehose: Required to support `NewAccount` tracing that is still valid on Arbitrum
	// as it emits a Firehose 2.3 model. Sets if `state.NewHookedState` is called.

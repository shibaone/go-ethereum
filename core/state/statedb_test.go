...
func TestMVHashMapReadWriteDelete(t *testing.T) {
	...
	// Tx3 delete
	states[3].SelfDestruct(addr, firehose.NoOpContext)
...
func TestMVHashMapRevert(t *testing.T) {
	...
	states[1].SelfDestruct(addr, firehose.NoOpContext)
...
func TestApplyMVWriteSet(t *testing.T) {
	...
	// Tx3 write
	states[3].SelfDestruct(addr2, firehose.NoOpContext)
	states[3].SetCode(addr1, code, firehose.NoOpContext)
	states[3].Finalise(true)
	states[3].FlushMVWriteSet()

	sSingleProcess.SelfDestruct(addr2, firehose.NoOpContext)

...
const (
	_GasChangeReason_name_0 = ""
	_GasChangeReason_name_1 = "GasChangeIgnored"
)

var (
	_GasChangeReason_index_0 = [...]uint16{0, 20, 45, 68, 86, 113, 140, 169, 198, 227, 257, 281, 300, 332, 362, 390, 418, 450, 475, 513}
)

...
func TestOpenDrops(t *testing.T) {
	...
	statedb.AddBalance(crypto.PubkeyToAddress(gapper.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(dangler.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(filler.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.SetNonce(crypto.PubkeyToAddress(filler.PublicKey), 3)
	statedb.AddBalance(crypto.PubkeyToAddress(overlapper.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.SetNonce(crypto.PubkeyToAddress(overlapper.PublicKey), 2)
	statedb.AddBalance(crypto.PubkeyToAddress(underpayer.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(outpricer.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(exceeder.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(overdrafter.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(overcapper.PublicKey), uint256.NewInt(10000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(duplicater.PublicKey), uint256.NewInt(1000000), 0x0)
	statedb.AddBalance(crypto.PubkeyToAddress(repeater.PublicKey), uint256.NewInt(1000000), 0x0)
...
func TestOpenIndex(t *testing.T) {
	...
	// Create a blob pool out of the pre-seeded data
	statedb, _ := state.New(types.EmptyRootHash, state.NewDatabase(rawdb.NewDatabase(memorydb.New())), nil)
	statedb.AddBalance(addr, uint256.NewInt(1_000_000_000), 0x0)
	statedb.Commit(0, true)
...
func TestOpenHeap(t *testing.T) {
	...
	// Create a blob pool out of the pre-seeded data
	statedb, _ := state.New(types.EmptyRootHash, state.NewDatabase(rawdb.NewDatabase(memorydb.New())), nil)
	statedb.AddBalance(addr1, uint256.NewInt(1_000_000_000), 0x0)
	statedb.AddBalance(addr2, uint256.NewInt(1_000_000_000), 0x0)
	statedb.AddBalance(addr3, uint256.NewInt(1_000_000_000), 0x0)
	statedb.Commit(0, true)
...
func TestAdd(t *testing.T) {
	...
	for i, tt := range tests {
		...
		for acc, seed := range tt.seeds {
			...
			statedb.AddBalance(addrs[acc], new(uint256.Int).SetUint64(seed.balance), 0x0)
...
func benchmarkPoolPending(b *testing.B, datacap uint64) {
	...
	for i := 0; i < int(capacity); i++ {
		...
		statedb.AddBalance(addr, uint256.NewInt(1_000_000_000), 0)
		pool.add(tx)
	}
	statedb.Commit(0, true)
	defer pool.Close()
